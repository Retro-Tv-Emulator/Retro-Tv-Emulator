...
export default function LoadingScreen({ onLoadingComplete }: LoadingScreenProps) {
  ...
  // Preload the icon using an actual image element but don't render it
  useEffect(() => {
    const preloadImage = document.createElement('img')
    preloadImage.src = ICON_URL
    preloadImage.onload = () => setIconLoaded(true)
    preloadImage.onerror = () => setIconError(true)
  }, [])
